  ...
  return (
    <>
      <div className="wrapper fadeInDown">
        <div id="formContent">
          <span >
            <Image src="/reverde-logo.png" alt="Vercel Logo" width={125} height={76} />
          </span>
          {/* <h2 className="active"> Reverde-Test </h2> */}
          <form>
            <input
              type="text"
              id="login"
              ...
              name="login"
              placeholder="Entre com o ID de sua organização (Parâmetro Opcional)"
            ...
            <input
              ...
              name="key"
              placeholder="Entre com sua API KEY"
              onChange={openAIAPIKeyChange}
            />
            <input
              type="button"
              className="fadeIn fourth"
              value={state?.common?.isLoggedIn ? "Continuar" : "Autenticar"}
